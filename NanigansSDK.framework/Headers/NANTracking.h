//  Copyright (c) 2013-2016 Nanigans. All rights reserved.
 ...
 */
- (void)request: (NSURLRequest *)request completedWithError: (NSError *)error;
...
+(void)trackNanigansEvent: (NSString *)uid
                     type: (NSString *)type
                     name: (NSString *)name __deprecated;

+(void)trackNanigansEvent: (NSString *)uid
                     type: (NSString *)type
                     name: (NSString *)name
                    value: (NSString *)value __deprecated;

+(void)trackNanigansEvent: (NSString *)uid
                     type: (NSString *)type
                     name: (NSString *)name
              extraParams: (NSDictionary *)extraParams __deprecated;
